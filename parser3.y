...
/*
if_else_statement:
        declaration ';' {execute_flag=0;}
        | assignment ';' {execute_flag=0;}
        | if_statement {execute_flag=0;}
        //| while_statement
        | io_statement ';' {execute_flag=0;}
        | compound_statement {execute_flag=0;}
        ;
